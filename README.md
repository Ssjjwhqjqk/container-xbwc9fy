...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xbwc9fy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xbwc9fy.containers.anotherwebservice.com/
...
```
git clone git@github.com:Ssjjwhqjqk/container-xbwc9fy.git
cd container-xbwc9fy
```
...
```
docker attach container-xbwc9fy
```
